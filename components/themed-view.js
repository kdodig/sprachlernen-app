...
function ThemedView(_a) {
    ...
    var backgroundColor = (0, use_theme_color_1.useThemeColor)({ light: lightColor, dark: darkColor }, 'background');
    return (0, jsx_runtime_1.jsx)(react_native_1.View, __assign({ style: [{ backgroundColor: backgroundColor }, style] }, otherProps));
}
